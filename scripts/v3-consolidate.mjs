...
if (!index.includes('/assets/js/gallery-modal-portal.js')) index = index.replace('</body>', '  <script src="/assets/js/gallery-modal-portal.js" defer></script>\n</body>');
